...
local BOX_SIZE, BOX_OFFSET_Y = 30, 4

local IDLE = { 0.55, 0.40, 0.12, 0.75 }
local ACTIVE = { 0.94, 0.62, 0.15, 0.95 }
...
local function AcquireBox(unit)
	...
	box.label:SetTextColor(0.10, 0.06, 0.01)
...
function handlers.UNIT_SPELLCAST_INTERRUPTIBLE(unit)
	if IsNameplate(unit) then
		casting[unit] = true
		Refresh(unit)
	end
